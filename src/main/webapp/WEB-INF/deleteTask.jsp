...
<div class="container">
    ...
    %>
    <h1 class="mt-5 mb-3">Deletar Tarefa <%=taskid%> </h1>
    <form  action="<%= request.getContextPath() %>/deleteTask" method="post">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="descricao" value="oi mundo lindo" name="descricao" readonly="true" rows="3" ><%=task.get(i).getDescricao()%></textarea>
        </div>
        <div class="mb-3">
            <label for="data_conclusao" class="form-label">Data de Conclusão</label>
            <input type="date" class="form-control" id="data_conclusao"  name="data_conclusao" readonly="true">
        </div>
        <div class="mb-3">
            <label for="status" class="form-label">Status</label>
            <select class="form-select" id="status"name="status" readonly="true">
